			...
			<view class="merchant-content">
				...
				<view class="list">
					<view class="item margin-top-sm padding-top" v-for="(item,index) in list" :key="index">
						...
						<view class="flex align-center justify-between margin-bottom-xs" v-if="current == 0">
							<view class="label">
								商户号：
							</view>
							<view class="right flex align-center">
						...
						<view class="flex align-center justify-between padding-bottom">
							<view class="">
								<text v-if="current == 1" class="label">激活截至：</text>
								<text v-else class="label">绑定日期：</text>
							</view>
							<view class="">
								<text v-if="current == 1" >{{item.weijihuo_koutime}}</text>
								<text v-else>{{item.bdtime}}</text>
							</view>
						</view>
