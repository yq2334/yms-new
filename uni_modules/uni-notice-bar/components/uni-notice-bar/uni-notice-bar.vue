<template>
	<view v-if="show" class="uni-noticebar" :style="{ backgroundColor }" @click="onClick">
		<uni-icons v-if="(showIcon === true || showIcon === 'true' )&& (showIconImg === 'false' || showIconImg === false)" class="uni-noticebar-icon" type="sound"
			:color="color" :size="fontSize * 1.5" />
		<img class="showIconImg" v-if="showIconImg && (showIcon === 'false' || showIcon === false)" :src="showIconImg" alt="" >
