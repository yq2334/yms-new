		...
		<view class="example">
			<uni-forms ref="form" border :model="user" labelWidth="160px" :rules="rules">
				...
				<uni-forms-item label="社保卡号" name="socialCardNumber" required>
					<uni-easyinput :inputBorder="false" :clearable="false" v-model="user.socialCardNumber" placeholder="请输入"
				...
				<uni-forms-item label="现住址所在地区" name="district" required>
					<u-picker :show="show" ref="uPicker" :columns="cityList" @cancel="handleCancel" @confirm="confirm"
				...
				<uni-forms-item label="联系人关系" name="contractRelation" required>
					<uni-data-select v-model="user.contractRelation" :localdata="relationType" @change="change" :clear="false">
					</uni-data-select>
				</uni-forms-item>
